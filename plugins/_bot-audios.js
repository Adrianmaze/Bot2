...
let handler = async (m, { conn }) => {
  ...
  try {
    ...
    switch (text) {
        ...
        case 'hijos de puta':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://qu.ax/rrXte.m4a', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
